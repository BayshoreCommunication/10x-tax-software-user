          ...
          <form action="" className="flex flex-col space-y-3 2xl:space-y-5">
            ...
            <div className="w-full">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-center ps-4 bg-[#383E54] border border-white border-opacity-10 text-lg rounded-md w-full placeholder-white placeholder-opacity-80 outline-none text-white">
                  <input
                    id="bordered-radio-1"
                    type="radio"
                    value="itemized-deduction"
                    name="bordered-radio"
                    className="peer w-5 h-5 appearance-none border border-white border-opacity-10 rounded-full bg-[#383E54] checked:bg-primary checked:border-primary focus:outline-none"
                  />
                  <label
