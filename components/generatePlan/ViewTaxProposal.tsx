    ...
    <div className="flex flex-col gap-6 2xl:gap-10">
      ...
      >
        <div className="max-w-xl 2xl:max-w-2xl ">
          ...
          <h4 className="text-3xl 2xl:text-4xl font-normal mb-4 text-[#28C3E1]">
      ...
      <div className="text-black text-start px-10 pt-10 pb-32 2xl:px-20 2xl:pt-20 2xl:pb-40 relative min-h-[750px] flex items-center bg-[#F0F3F7] border-t-8 border-[#28C3E1]">
      ...
      <div>
        <div className="min-h-[750px] h-full relative flex  ">
          {/* Left Blue Section */}
          <div className="bg-[#28C3E1] w-1/4 "></div>
              ...
              <div className="max-w-xl 2xl:max-w-2xl px-10 py-20">
                ...
                <ul className="space-y-3">
                  <li className="flex justify-between items-center text-lg 2xl:text-xl font-normal text-black">
                    ...
                    <span className="text-[#28C3E1]">4</span>
                  </li>
                  <li className="flex justify-between items-center text-lg 2xl:text-xl font-normal text-black">
                    <span>Your Estimated Tax Savings</span>
                    <span className="text-[#28C3E1]">5</span>
                  </li>
                  <li className="flex justify-between items-center text-lg 2xl:text-xl font-normal text-black">
                    <span>What You Lost Last Year</span>
                    <span className="text-[#28C3E1]">6</span>
                  </li>
                  <li className="flex justify-between items-center text-lg 2xl:text-xl font-normal text-black">
                    <span>Categories of Tax Planning Strategies</span>
                    <span className="text-[#28C3E1]">7</span>
                  </li>
                  <li className="flex justify-between items-center text-lg 2xl:text-xl font-normal text-black">
                    <span>Stages of Tax Planning</span>
                    <span className="text-[#28C3E1]">8</span>
                  </li>
                  <li className="flex justify-between items-center text-lg 2xl:text-xl font-normal text-black">
                    <span>Tax Engagement Options</span>
                    <span className="text-[#28C3E1]">9</span>
                  </li>
                  <li className="flex justify-between items-center text-lg 2xl:text-xl font-normal text-black">
                    <span>Next Steps In The Planning Process</span>
                    <span className="text-[#28C3E1]">10</span>
                  </li>
                  <li className="flex justify-between items-center text-lg 2xl:text-xl font-normal text-black">
                    <span>We Look Forward To Working With You</span>
                    <span className="text-[#28C3E1]">11</span>
                  </li>
                  <li className="flex justify-between items-center text-lg 2xl:text-xl font-normal text-black">
                    <span>Frequently Asked Questions (FAQ)</span>
                    <span className="text-[#28C3E1]">12</span>
                  </li>
                  <li className="flex justify-between items-center text-lg 2xl:text-xl font-normal text-black">
                    <span>Important Information </span>
                    <span className="text-[#28C3E1]">13</span>
                  </li>
                </ul>
              </div>
            </div>
      ...
      <div>
        <div className="min-h-[750px] h-full relative flex  ">
          <div className="text-black text-start px-10 pt-10 pb-10 2xl:px-20 2xl:pt-20 2xl:pb-20 relative min-h-[750px] flex items-center bg-[#F0F3F7] border-t-8 border-[#28C3E1] w-full">
            <div className="flex flex-col h-full gap-8 2xl:gap-14 ">
              ...
              <div className="grid grid-cols-3 ">
                <div className="flex  justify-between items-end gap-2 pe-6 2xl:pe-20 py-5">
                  <div className="flex flex-col justify-between items-end gap-2">
                    <h4 className="text-3xl font-bold text-[#28C3E1]">2023</h4>
                ...
                <div className="flex  justify-between items-end gap-2 px-6 2xl:px-20 border-x-2 border-[#28C3E1] py-5">
                  <div className="flex flex-col justify-between items-end gap-2">
                    <h4 className="text-3xl font-bold text-[#28C3E1]">2023</h4>
                    <p className="text-end text-lg leading-[130%]">
                      Estimated <br /> Overpayment
              ...
              <div className="grid grid-cols-3 mt-10">
                <div>
                  <p className=" text-base text-justify leading-[130%] pe-10 2xl:pe-20 border-r-2  border-[#28C3E1] py-5">
      ...
      <div>
        <div className="min-h-[750px] h-full relative flex  ">
          <div className="text-black text-start px-10 pt-10 pb-10 2xl:px-10 2xl:pt-20 2xl:pb-20 relative min-h-[750px] flex items-center bg-[#F0F3F7] border-t-8 border-[#28C3E1] w-full">
            <div className="flex flex-col h-full gap-10 2xl:gap-20 w-full justify-center items-center">
              ...
              <div className="flex items-end justify-between gap-2 w-full">
                ...
                <h4 className="text-3xl font-bold text-[#28C3E1] ">+</h4>
                <div className="flex  justify-between items-end gap-2 ">
                  <div className="flex flex-col justify-between items-end gap-2">
                    <h4 className="text-3xl font-bold text-[#28C3E1]">2023</h4>
                    <p className="text-end text-lg leading-[130%]">
                ...
                <p className="text-start text-base font-bold leading-[130%] max-w-xs">
                  What you paid. It's just that the accountant split it with the
                  IRS...
                </p>
              </div>
              <div className="grid grid-cols-3 mt-10">
