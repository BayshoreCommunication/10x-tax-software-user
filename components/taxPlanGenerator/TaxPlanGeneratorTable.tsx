...
//     // Function to handle page numbering and showing ellipsis
//     const renderPageNumbers = () => {
//       let pageNumbers: (string | number)[] = [];

//       if ((pagination?.totalPages && pagination?.totalPages) ?? 0 <= 2) {
//         pageNumbers = pages; // Show all if only two pages
//       } else {
//         pageNumbers = [1, 2]; // Always show 1 and 2

//         if (currentPage > 3) {
//           pageNumbers.push("..."); // Show "..." if currentPage is greater than 3
//         }

//         if (pagination?.totalPages ?? 0 - currentPage ?? 0 >= 2) {
//           pageNumbers.push(pagination?.totalPages ?? 0); // Always show the last page if there are enough pages
//         }
//       }
...
//           </div>
//         )}
//         <div className="mr-4"> {renderPagination}</div>
//       </div>
//     </div>
//   );
// };
