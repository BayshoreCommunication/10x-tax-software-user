...
import { userForgetPasswordProcessOtpCheck } from "@/app/actions";
...
type Props = {
  setUserForgotPasswordRecovery: (flag: boolean) => void;
  setUserForgotPasswordFlag: (flag: boolean) => void;
  userForgotPasswordInfo: UserForgotPasswordInfo;
};

const ForgetPasswordOtpVerificationForm = ({
  setUserForgotPasswordRecovery,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formData.append(
        "email",
        userForgotPasswordInfo?.email || "arsahak.bayshore@gmail.com"
      );
      formData.append("otp", fullOtp);

      const response = await userForgetPasswordProcessOtpCheck(formData);
...
export default ForgetPasswordOtpVerificationForm;
